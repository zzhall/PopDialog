...
public class PopDialog {
    ...
    private void initDialog(final Context context) {
        ...
        dialog.setOnDismissListener(new DialogInterface.OnDismissListener() {
            ...
            public void onDismiss(DialogInterface dialog) {
                if (onPopDialogDismissed != null) {
                    onPopDialogDismissed.onDismissed();
                }
            }
        });
        dialog.setOnShowListener(new DialogInterface.OnShowListener() {
            ...
            public void onShow(DialogInterface dialog) {
                if (onPopDialogShow != null) {
                    onPopDialogShow.onShow();
                }
            }
        });
        ...
        defaultLeftMargin = context.getResources().getDimensionPixelOffset(R.dimen.pop_dialog_default_left_margin);
        defaultRightMargin = context.getResources().getDimensionPixelOffset(R.dimen.pop_dialog_default_right_margin);
        ini();
    }
     ...
     * 设置提示框中要显示的内容
     */
    public PopDialog setLayout(View layout) {
        if (layout != null) {
     ...
     * 设置提示框中要显示的内容的布局Id
     */
    public PopDialog setLayoutResourceId(int layoutResourceId) {
     ...
     * 设置提示框中要显示的内容的布局Id
     */
    public PopDialog setOnViewItemClickListener(final OnViewItemClickListener listener, @IdRes int... itemId) {
        if (contentView != null) {
            for (int i : itemId) {
                contentView.findViewById(i).setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        listener.onClick(v, PopDialog.this);
                    }
                });
            }
        }
     ...
     * 设置三角形所在的位置
     */
    public PopDialog setLocation(int[] location) {
     ...
     */
    public PopDialog setLocationByAttachedView(View attachedView) {
     ...
     */
    public PopDialog setMatchParent(boolean matchParent) {
     ...
     * 距离屏幕左右的边距
     */
    public PopDialog setMarginLeftAndRight(int left, int right) {
    ...
    public PopDialog setMarginTopAndBottom(int top, int bottom) {
        RelativeLayout.LayoutParams layoutParams = (RelativeLayout.LayoutParams) llContent.getLayoutParams();
     ...
     * 设置触摸对话框外面，对话框是否消失
     */
    public PopDialog setTouchOutsideDismiss(boolean touchOutsideDismiss) {
     ...
     * 设置提醒框外部区域的颜色
     */
    public PopDialog setOutsideColor(int color) {
     ...
     */
    public PopDialog setBackgroundColor(int color) {
     ...
     */
    public PopDialog setCornerRadius(int cornerRadius) {
     ...
     */
    public PopDialog setAnimationTranslationShow(int direction, int duration, float... values) {
     ...
     * @param values    动画移动的位置
     */
    public PopDialog setAnimationTranslationDismiss(int direction, int duration, float... values) {
        return setAnimationTranslation(false, direction, duration, values);
    }

    private PopDialog setAnimationTranslation(boolean isShow, int direction, int duration, float... values) {
     ...
     * @param values   动画移动的位置
     */
    public PopDialog setAnimationAlphaShow(int duration, float... values) {
     ...
     * @param values   动画移动的位置
     */
    public PopDialog setAnimationAlphaDismiss(int duration, float... values) {
        return setAnimationAlpha(false, duration, values);
    }

    private PopDialog setAnimationAlpha(boolean isShow, int duration, float... values) {
...
//        ObjectAnimator.ofFloat(rlOutsideBackground.findViewById(R.id.rlParentForAnimate), "scaleY", 0.3f, 1.0f).setDuration(500).start();
     ...
     * 设置是否可以按返回按钮取消
     */
    public PopDialog setCancelable(boolean cancelable) {
        dialog.setCancelable(cancelable);
        return this;
    }

    private OnPopDialogDismissed onPopDialogDismissed;

    public PopDialog setOnPopDialogDismissed(OnPopDialogDismissed onPopDialogDismissed) {
        this.onPopDialogDismissed = onPopDialogDismissed;
        return this;
    }
     ...
     * Dialog is dismissed
     */
    public interface OnPopDialogDismissed {
        public void onDismissed();
    }

    private OnPopDialogShow onPopDialogShow;

    public PopDialog setOnPopDialogShow(OnPopDialogShow onPopDialogShow) {
        this.onPopDialogShow = onPopDialogShow;
        return this;
    }
    ...
    public interface OnPopDialogShow {
        public void onShow();
    }

    public interface OnViewItemClickListener {
        void onClick(View clickView, PopDialog dialog);
    }
}
